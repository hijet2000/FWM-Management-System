...
import { Site, PermissionAction } from '../../types.ts';
import { apiService } from '../../src/services/apiService.ts';
import Button from '../ui/Button.tsx';

const Header: React.FC = () => {
  const { user, logout, currentSite, setCurrentSite, can } = useAuth();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
             {currentSite && can(PermissionAction.MANAGE, 'settings', { siteId: currentSite.id }) && (
                <Link to="/settings" className="p-2 rounded-full text-gray-500 hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 focus:outline-none" title="Settings">
